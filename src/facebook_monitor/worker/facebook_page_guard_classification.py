"""Facebook page guard 的純 evidence、分類與 diagnostics 組裝。

職責：依 bounded marker context 與 URL/session 訊號產生 typed finding；不得承載
browser I/O、WorkerFailure 轉換、retry policy、incident persistence 或 scheduler 行為。
"""
