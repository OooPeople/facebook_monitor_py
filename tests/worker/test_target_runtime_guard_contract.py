...
FORMAL_RUNTIME_BOUNDARY_FILES = (
    ...
    ROOT / "src/facebook_monitor/worker/resident_cover_image_attempt.py",
    ROOT / "src/facebook_monitor/worker/resident_cover_image_queue.py",
    ROOT / "src/facebook_monitor/worker/resident_cover_image_refresh.py",
    ROOT / "src/facebook_monitor/worker/resident_maintenance_eligibility.py",
