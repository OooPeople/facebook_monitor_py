...
@dataclass(frozen=True)
class FacebookTemporaryBlockWarningDefaults:
    """保存 temporary-block advisory warning 的跨層預設值。"""

    warning_seconds: int = 12 * 60 * 60
...
PYTHON_FACEBOOK_TEMPORARY_BLOCK_WARNING_DEFAULTS = (
    FacebookTemporaryBlockWarningDefaults()
)
