...
- macOS zip 有 `Facebook Monitor.app`，主要 executable / updater / bundled browser / launcher 保留 arm64 Mach-O 與 executable bit，且 `.app` bundle 保留 app icon、Info.plist identity 與 ad-hoc signature metadata。
