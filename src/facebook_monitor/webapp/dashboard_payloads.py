...
def serialize_facebook_temporary_block_warning(
    warning: FacebookTemporaryBlockWarningBanner,
) -> dict[str, object]:
    """序列化首頁與 Start 共用的最小 temporary-block warning。"""

    return {
        "active": warning.active,
        "title": warning.title,
        "message": warning.message,
        "warning_until": warning.warning_until,
