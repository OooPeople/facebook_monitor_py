...
def test_create_target_use_case_adds_group_posts_target_with_resolved_metadata(
    tmp_path: Path,
) -> None:
    """scheduler stopped 時可把同步解析的 metadata 與 posts target 一起保存。"""
...
def test_create_target_use_case_marks_metadata_refresh_pending_when_scheduler_running(
    ...
    """scheduler running 時不搶 profile，改由 resident 補 metadata。"""
