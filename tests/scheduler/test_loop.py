...
from facebook_monitor.scheduler.loop import list_schedulable_target_ids
...
def test_scheduler_loop_scans_targets_sequentially_and_updates_runtime_state(
    ...
    def fake_scan_once(options: WorkerOnceOptions) -> GroupPostsScanSummary:
...
def test_scheduler_loop_marks_extractor_empty_as_idle_after_failed_scan(
    ...
    def fake_scan_once(_options: WorkerOnceOptions) -> GroupPostsScanSummary:
        """模擬 extractor 空結果。"""
