...
- **Windows portable updater**：正式 EXE 版可從 GitHub stable Release 檢查、下載、驗證 SHA256，並透過獨立 updater 替換 app files、保留 `data/`。
...
- [打包說明](packaging/README.md)：Windows portable EXE、Release asset 與 frozen smoke checklist。
