...
def test_scan_comments_page_records_latest_scan_and_seen_scope(tmp_path: Path) -> None:
...
def test_scan_comments_page_collapses_duplicate_comment_text_in_notification(
    tmp_path: Path,
) -> None:
...
def test_scan_comments_page_uses_nested_scroll_load_more(tmp_path: Path) -> None:
