...
MACOS_PACKAGING_MODE = "pyinstaller-macos-arm64-onedir"


def parse_args() -> argparse.Namespace:
    """解析 macOS release build CLI 參數。"""
    ...
    steps.extend(
        [
            ReleaseBuildStep(
                ...
                env_overrides=metadata_env(packaging_mode=MACOS_PACKAGING_MODE),
            ),
            ReleaseBuildStep(
...
def main() -> int:
    ...
    if sys.platform != "darwin":
        print("build_macos_release.py must be run on macOS.")
        return 2
