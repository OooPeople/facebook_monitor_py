...
Settings 頁「問題回報與診斷」內的「下載支援診斷包」會建立 redacted zip，內容只含 runtime 診斷、路徑摘要、table counts、通知佇列摘要與 DB invariant 檢查結果。診斷包刻意不包含 SQLite DB、browser profile、cookies、secrets、logs、完整貼文/留言內容或完整 webhook。
