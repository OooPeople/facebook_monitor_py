"""Phase B headed group posts target capture。

職責：開啟既有 automation profile，讓使用者切到 Facebook 社團首頁後，
擷取目前 URL 並寫入 Phase A application service。
"""
